...
const { BotFrameworkAdapter, ConversationState, MemoryStorage, UserState, builder } = require('botbuilder');
...
//secondary handler
const dialog2 = new MainDialog();
const bot2 = new RichCardsBot(conversationState, userState, dialog2);
...
server.post('/api/messages', (req, res) => {
    adapter.processActivity(req, res, async (turnContext) => {
        ...
        if(text == "cartao" || text == "All Cards" || text == "Adaptive Card" || text == "Audio Card" || text == "OAuth Card" || text == "Animation Card" || text == "Hero Card" || text == "Receipt Card" || text == "Signin Card"|| text == "Thumbnail Card" || text == "Video Card"){
            definidorBot = bot2;
        }
        else{
            definidorBot = bot;
        ...
        await definidorBot.run(turnContext);
